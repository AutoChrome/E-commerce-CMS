                                ...
                                <div class="grid-container fluid">
                                    ...
                                    <div class="grid-x grid-padding-x">
                                        ...
                                        <div class="medium-4 cell">
                                            <label>Code
                                                <input id="code" name="code" type="text" placeholder="SALE2019">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="grid-x grid-padding-x">
                                        <div class="medium-4 cell">
                                            <label>Percent discount
                                                <input id="discount" name="discount" type="number" placeholder="5">
                                            </label>
                                        </div>
                                        <div class="medium-4 cell">
                                            <label>Usages
                                                <input id="usages" name="usages" type="number" placeholder="0" value="0">
                                    ...
                                    <div class="grid-x grid-padding-x">
                                        <div class="medium-2 medium-offset-10 cell">
                                            <button class="button success" onclick="createCoupon(); return false;">Create</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
