...
<html class="no-js">
    ...
    <body>
                        ...
                        <div class="grid-x">
                            <div class="cell large-4 content-padding">
                                ...
                                <div class="bd padding">
                                    <?php
                                    $count = $databaseHandler->countProducts(null);
                                    
                                    echo '<p style="text-align:center; font-size:48px;">' . $count . '</p>';
                                    ?>
                                </div>
                            </div>
                        </div>
        ...
        <script src="scripts/custom-scripts/product-manager.js"></script>
        <script>
